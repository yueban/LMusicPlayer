...
public class ActivityOptionsCompatICS {
     ...
     * @param height：新activity的起始高度                          Create an ActivityOptions specifying an animation where the new activity is
     ...
     * @param startY：动画开始的Y坐标，相对于source Create an ActivityOptions specifying an animation where a thumbnail
     ...
     * @param sharedElementId：新的activity中要接收动画效果的元素的id，这样就得到了两个view之间的联系 通过两点一线的方式来进行补间动画。
     *                                                                   <p/>
