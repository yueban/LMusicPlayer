...
public class Const {
    ...
    public static final int COMMAND_AUDIO_PLAY = 1001;//播放新的音频
    public static final int COMMAND_AUDIO_START = 1002;//播放
    public static final int COMMAND_AUDIO_PAUSE = 1003;//暂停
    public static final int COMMAND_AUDIO_PREVIOUS = 1004;//上一首
    public static final int COMMAND_AUDIO_NEXT = 1005;//下一首
    public static final int COMMAND_AUDIO_REPEAT = 1006;//重复播放模式
    public static final int COMMAND_AUDIO_RANDOM = 1007;//随机播放模式
}
